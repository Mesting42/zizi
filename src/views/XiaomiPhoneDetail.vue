  ...
  <div class="xiaomi-phone-page" :style="{ '--accent': product.accent, '--art-bg': product.artBg, '--art-ink': product.artInk }">
    <header class="xiaomi-phone-nav">
      <a class="xiaomi-phone-brand" :href="matrixHref" aria-label="返回小米全生态机型矩阵">
        <img src="/xiaomi/img/xiaomi-official-logo.svg" alt="Xiaomi" />
    ...
    <footer class="xiaomi-phone-footer"><div><img src="/xiaomi/img/xiaomi-official-logo.svg" alt="Xiaomi" /><span>小米全生态体验项目 / 2026</span></div><a class="xiaomi-phone-back" :href="matrixHref">回到机型矩阵 <span>↑</span></a></footer>
  </div>
</template>
...
const product = computed(() => {
  ...
  if (route.params.model === 'mix') {
    return {
      ...base,
      image: '/xiaomi/img/xiaomi-mix-flip-hand-transparent.png',
      artType: 'mix-photo',
      artLabel: 'MIX FLIP',
...
const matrixHref = computed(() => route.query.fromPreview === '1'
  ? '/xiaomi/index.html?xiaomi=1#phones'
  : '/xiaomi-case#phones')
let observer
